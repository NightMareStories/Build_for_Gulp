# Внимание!!! Данная сборка "Gulp" в этой ветке использует "старый" функциональный подход. Если вы используете "новый" модульный подход "ES6" в своих проектах, то перейдите в ветку "new_gulp"!
&nbsp;
# Данная документация актуальна только для ветки "old_gulp"!!!
&nbsp;
